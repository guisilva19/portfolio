...
export const projectsList: IProject[] = [
  {
    ...
    description: "Quick Loan é uma iniciativa inovadora voltada para a criação de uma plataforma de empréstimo rápido, com foco na agilidade, transparência e facilidade de acesso aos serviços financeiros.",
